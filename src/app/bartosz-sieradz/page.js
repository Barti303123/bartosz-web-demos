      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <motion.p variants={itemVars} className="text-xl md:text-2xl text-gray-300 mb-10 max-w-2xl mx-auto font-light drop-shadow-lg">
            Dołącz do bartosz w Sieradz i odmień swoje ciało dzięki elitarnym trenerom oraz najnowocześniejszemu sprzętowi.
          </motion.p>
          <motion.div variants={itemVars}>
            <a href="/bartosz-sieradz/contact" className="inline-flex items-center gap-2 bg-[#ccff00] text-black px-8 py-4 font-bold text-lg uppercase -skew-x-12 hover:bg-white hover:text-black transition-all duration-300 shadow-[0_0_20px_rgba(204,255,0,0.6)] hover:shadow-[0_0_30px_rgba(255,255,255,0.8)] relative group overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-extrabold uppercase tracking-tight">
              Dlaczego Wybrać <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ccff00] to-lime-500">bartosz</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: Trophy, title: "Mentoring Ekspertów", desc: "Czerp wiedzę od czołowych profesjonalistów fitness w Sieradz." }
            ].map((feat, i) => (
              <motion.div 
                key={i}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-md">
              Odwiedź nas pod adresem ul. Główna 1, Sieradz lub skontaktuj się telefonicznie pod numerem +48 500 123 456, aby odebrać swój ekskluzywny karnet próbny już dziś.
            </p>
            <a href="/bartosz-sieradz/contact" className="inline-flex items-center gap-2 bg-transparent border-2 border-[#ccff00] text-[#ccff00] px-8 py-4 font-bold text-lg uppercase -skew-x-12 hover:bg-[#ccff00] hover:text-black transition-all duration-300 shadow-[0_0_15px_rgba(204,255,0,0.3)] hover:shadow-[0_0_30px_rgba(204,255,0,0.8)] group relative overflow-hidden">
