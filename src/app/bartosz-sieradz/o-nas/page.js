          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p variants={itemVars} className="text-lg text-gray-400 leading-relaxed font-light">
                W samym sercu Sieradz, <span className="text-white font-bold">bartosz</span> narodziło się z jedną, nadrzędną misją: stworzyć przestrzeń, gdzie wymówki przestają istnieć. To sanktuarium dla tych, którzy są oddani, zdeterminowani i nieustępliwi w dążeniu do perfekcji.
              </motion.p>
              <motion.p variants={itemVars} className="text-lg text-gray-400 leading-relaxed font-light">
