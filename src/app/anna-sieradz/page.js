        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-stone-300 max-w-2xl mx-auto mb-10 font-light">
              Zanurz się w niezapomnianą podróż kulinarną w anna, gdzie każde danie opowiada historię pasji, precyzji i najszlachetniejszych składników.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-20 text-center">
          ...
          >
            ...
            <p className="text-stone-300 mb-10 max-w-xl mx-auto font-light text-lg">
              Zarezerwuj stolik już dziś i pozwól nam uraczyć Cię najwytworniejszymi smakami w sieradz.
            </p>
            <motion.a 
              href="/contact"
              whileHover={{ scale: 1.05 }}
