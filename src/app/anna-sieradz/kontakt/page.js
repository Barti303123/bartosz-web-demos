...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-200 font-sans selection:bg-amber-600 selection:text-white">
      <Navbar slug="anna-sieradz" companyName="anna" dark={true} />
      ...
      <section ref={headerRef} className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <motion.div style={{ y, opacity }} className="absolute inset-0 z-0">
          ...
          <img 
            src="https://images.unsplash.com/photo-1542314831-c53cd4b85aca?q=80&w=2000&auto=format&fit=crop" 
            ...
            >
              <div>
                ...
                <p className="text-stone-400 font-light text-lg mb-8">
                  Z ogromną przyjemnością powitamy Państwa w anna. W sprawie organizacji wydarzeń prywatnych lub realizacji wyjątkowych życzeń, uprzejmie prosimy o bezpośredni kontakt.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">ul. Główna 1, sieradz<br/>sieradz</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">+48 500 123 456</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">Twojego maila</p>
                  </div>
                </div>
