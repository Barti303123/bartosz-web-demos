          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-stone-300 font-light text-lg leading-relaxed">
                <p>
                  Założona w sercu sieradz, restauracja anna narodziła się z głębokiego szacunku dla sezonowych składników i ponadczasowych technik kulinarnych. Wierzymy, że posiłek to coś więcej niż tylko pożywienie – to doświadczenie, wspomnienie, chwila dzielona z bliskimi.
                </p>
                <p>
      ...
      <section className="py-24 bg-stone-900 border-t border-stone-800">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { icon: Leaf, title: "Lokalne Składniki", desc: "Współpracujemy z lokalnymi rolnikami w sieradz, aby codziennie dostarczać Państwu najświeższe, ekologiczne produkty." },
