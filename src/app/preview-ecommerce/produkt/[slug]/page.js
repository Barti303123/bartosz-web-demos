  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50">
        ...
        <Link href="/preview-ecommerce" className="text-blue-600 hover:underline inline-flex items-center gap-2">
    ...
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <main className="flex-grow pt-24 pb-12 px-6 sm:px-12 md:px-24">
        <div className="max-w-6xl mx-auto">
          <Link href="/preview-ecommerce" className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-900 transition-colors mb-8">
