            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+48 600 111 222" className="text-gray-600 font-light hover:text-[#C1A88B] transition-colors">+48 600 111 222</a>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:Twojego maila" className="text-gray-600 font-light hover:text-[#C1A88B] transition-colors">Twojego maila</a>
                </div>
              </div>
            </div>
          </motion.div>
