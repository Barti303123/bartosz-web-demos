    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#4A3B32] font-sans selection:bg-[#C5A880] selection:text-white">
            ...
            <div className="space-y-8">
              <motion.div variants={fadeIn}>
                ...
                <p className="text-gray-600 font-light leading-relaxed mb-4">
                  Założony z wizją redefiniowania standardów usług Salon Urody, Salon annna to coś więcej niż salon – to prawdziwa oaza spokoju. Wierzymy, że dbanie o siebie to konieczność, a nie luksus.
                </p>
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif mb-4">Doświadczenie Salon annna</h2>
