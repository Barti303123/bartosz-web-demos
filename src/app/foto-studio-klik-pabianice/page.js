...
import { Zap, Cpu, ArrowRight, Globe, Command } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
          <motion.div variants={stagger} initial="hidden" animate="visible" className="flex flex-col items-center">
            ...
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 backdrop-blur-md mb-8">
              <SparkleIcon />
              <span className="text-xs font-semibold tracking-widest text-indigo-300 uppercase">fotograf · Pabianice</span>
            </motion.div>

            <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white via-slate-200 to-slate-500 mb-8 leading-[1.1]">
              {content.hero.title}
            </motion.h1>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto">
              <a
                href="/foto-studio-klik-pabianice/kontakt"
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-2">{content.hero.cta} <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" /></span>
              </a>
              <a
                href="/foto-studio-klik-pabianice/o-nas"
      ...
      <section className="py-32 relative z-10 bg-[#030712]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">Co dla Ciebie zrobimy</h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto font-light">Poznaj zakres naszych usług — realizujemy je rzetelnie i z dbałością o szczegóły.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[250px]">
            ...
            >
              ...
              <p className="text-slate-400 text-lg leading-relaxed">{services[0]?.description}</p>
              ...
              <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=1000&auto=format&fit=crop" className="absolute -bottom-20 -right-10 w-3/4 opacity-20 mix-blend-screen rounded-tl-3xl filter blur-[2px] group-hover:blur-none transition-all duration-700" alt="Tło" />
            </motion.div>

            {/* Usługa 2 - szeroki kafel */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <p className="text-slate-400">{services[1]?.description}</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-400">{services[2]?.description}</p>
            </motion.div>
            ...
            {services[3] && (
              <motion.div
                ...
                className="rounded-3xl bg-slate-900/40 border border-slate-800/60 p-8 relative overflow-hidden hover:bg-slate-800/40 transition-colors backdrop-blur-xl bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=600&auto=format&fit=crop')] bg-cover bg-center group"
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-white mb-3">{services[3].title}</h3>
                  <p className="text-slate-300">{services[3].description}</p>
                </div>
              </motion.div>
            )}
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight">{content.contact.heading}</h2>
