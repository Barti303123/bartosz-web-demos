    ...
    <div className="min-h-screen bg-[#060D1A] text-[#F3F4F6] font-sans selection:bg-[#C5A059] selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-lg md:text-xl text-gray-400 font-light max-w-2xl leading-relaxed mb-12">
              kasia prawnik to zespół bezkompromisowych prawników z Wrocław, specjalizujących się w strategicznym doradztwie korporacyjnym i ochronie interesów naszych klientów.
            </motion.p>

            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
              <a 
                href="/kasia-prawnik-wroclaw/kontakt"
      ...
      <section className="py-24 relative overflow-hidden bg-[#0A1128]">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center flex flex-col items-center">
          ...
          <a href="/kasia-prawnik-wroclaw/kontakt" className="group relative px-12 py-6 bg-white text-[#060D1A] text-sm uppercase tracking-widest font-bold overflow-hidden shadow-2xl">
