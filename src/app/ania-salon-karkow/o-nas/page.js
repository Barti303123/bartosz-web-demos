          ...
          <div className="grid md:grid-cols-2 gap-12">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} transition={{ delay: 0.1 }}>
              ...
              <p className="text-[#7A7A7A] leading-relaxed mb-4">
                W <strong>{"ania salon"}</strong> wierzymy, że każda osoba posiada swoje unikalne piękno. Naszym celem nie jest zmienianie Ciebie, lecz podkreślenie tego, co w Tobie najpiękniejsze.
              </p>
