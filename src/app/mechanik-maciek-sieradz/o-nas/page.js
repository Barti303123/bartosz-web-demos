        ...
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            >
              ...
              <span className="text-red-400 text-sm font-semibold tracking-wider uppercase">O Nas · Sieradz</span>
            </motion.div>
            ...
            <p className="text-xl text-zinc-400 max-w-3xl leading-relaxed">
              Poznaj nasz warsztat, ludzi i podejście do każdego zlecenia — Mechanika Pojazdowa w Sieradz i okolicach.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <div className="text-zinc-300 font-semibold">Sieradz i okolice</div>
              </motion.div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 flex-shrink-0 relative z-10">
              <a
                href="/mechanik-maciek-sieradz/kontakt"
