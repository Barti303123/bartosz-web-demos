...
/* ─── Dane kontaktowe ────────────────────────────────────────────────── */
const CONTACT_ITEMS = [
  { icon: Phone,  label: "Telefon",          value: "797735708" },
  { icon: Mail,   label: "E-mail",           value: "farti30pg@gmail.com" },
...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 overflow-hidden font-sans">
      <Navbar slug="mechanik-maciek-sieradz" companyName="Mechanik Maciek" dark={true} />
      ...
      <section className="relative pt-40 pb-12 px-6 z-10">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-black uppercase tracking-tight mb-4 leading-none text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-200 to-red-500"
          >
            ...
            <div className="relative rounded-2xl overflow-hidden border border-zinc-800 flex-1 min-h-[180px]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-zinc-900/90 backdrop-blur-md border border-zinc-700 rounded-xl px-5 py-3 text-center">
                  ...
                  <p className="text-zinc-200 font-semibold text-sm">ul. Główna 1, Sieradz</p>
                  <p className="text-zinc-500 text-xs">Sieradz</p>
                </div>
              </div>
            </div>
          </motion.div>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="w-20 h-20 bg-amber-500/15 border border-amber-500/30 rounded-full flex items-center justify-center"
                  >
                    <CheckCircle className="w-10 h-10 text-amber-400" />
                  </motion.div>

                  <div>
                    <h3 className="text-3xl font-black mb-3">To wersja demonstracyjna</h3>
                    <p className="text-zinc-400 text-lg max-w-sm">
                      Wiadomość nie została wysłana. W pełnej wersji trafiłaby od razu do panelu zgłoszeń i na maila.
                    </p>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="other">Inne (opiszę w wiadomości)</option>
                    </select>
                  </div>
                  ...
                  <p className="text-center text-zinc-600 text-sm">
                    Wolisz zadzwonić?{" "}
                    <a href="tel:797735708" className="text-red-500 hover:text-red-400 font-semibold transition-colors">
                      797735708
                    </a>
                  </p>
                <DemoNotice wyslane={false} />
                </motion.form>
              )}
      ...
      <Footer companyName="Mechanik Maciek" />
    </div>
  );
}
