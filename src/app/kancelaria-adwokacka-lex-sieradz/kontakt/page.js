          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="relative z-10 max-w-lg space-y-10">
            <div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-white text-lg font-light">ul. Rynek 3<br/>Sieradz</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="tel:+48 555 200 005" className="text-white text-lg font-light hover:text-[#C5A059] transition-colors">+48 555 200 005</a>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="mailto:kancelaria@lex-sieradz.pl" className="text-white text-lg font-light hover:text-[#C5A059] transition-colors truncate">kancelaria@lex-sieradz.pl</a>
                </div>
              </div>
            </div>
          </motion.div>
