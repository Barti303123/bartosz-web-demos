...
const CONTACT_ITEMS = [
  ...
  { icon: Mail,   label: "E-mail",           value: "farti303pg@gmail.com" },
...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50 overflow-hidden font-sans">
      <Navbar slug="mechanik-adam-sieradz" companyName="Mechanik adam" dark={true} />
      ...
      <Footer companyName="Mechanik adam" />
    </div>
  );
}
