    ...
    <main className="bg-slate-950 text-white">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
        ...
        <motion.div initial="hidden" animate="visible" variants={fade} transition={{ duration: 1 }} className="relative z-10 text-center max-w-3xl px-6">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-xl mx-auto mb-10">{"kancelaria Andrzej"} zapewnia stanowcze doradztwo i zaciekłą obronę, gdy stawka jest najwyższa.</p>
          <a href={`/site/kancelaria-andrzej-bydgoszcz/contact`} className="inline-block bg-[#D4A853] hover:bg-[#c49a48] text-slate-950 font-semibold px-10 py-4 rounded transition-colors text-lg">Bezpłatna konsultacja</a>
        </motion.div>
      </section>
      ...
      <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} transition={{ duration: 0.8 }}
        ...
        <a href={`/site/kancelaria-andrzej-bydgoszcz/contact`} className="inline-block bg-[#D4A853] hover:bg-[#c49a48] text-slate-950 font-bold px-12 py-4 rounded transition-colors text-lg">Zacznij już dziś</a>
      </motion.section>
