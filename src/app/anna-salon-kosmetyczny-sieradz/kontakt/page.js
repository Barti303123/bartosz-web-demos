    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#4A3B32] font-sans selection:bg-[#C5A880] selection:text-white">
      ...
      <section className="pt-32 pb-16 px-4 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Get in <span className="italic bg-clip-text text-transparent bg-gradient-to-r from-[#C5A880] to-[#b0936c]">Touch</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            We'd love to hear from you. Book your Salon Urody appointment or reach out with any inquiries.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-[#E8DCCB]/30 relative overflow-hidden">
                ...
                <h3 className="text-2xl font-serif mb-8 text-[#4A3B32]">Contact Information</h3>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-[#4A3B32] mb-1">Our Location</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-[#4A3B32] mb-1">Phone</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-[#4A3B32] mb-1">Email</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-medium text-[#4A3B32] mb-1">Hours</h4>
                      <p className="text-gray-500 font-light text-sm">Mon - Fri: 9:00 AM - 7:00 PM</p>
                      <p className="text-gray-500 font-light text-sm">Sat: 10:00 AM - 5:00 PM</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="backdrop-blur-md bg-white/40 rounded-3xl p-8 md:p-10 shadow-lg border border-white/50">
                <h3 className="text-3xl font-serif mb-2">Send us a Message</h3>
                ...
                {formStatus === 'success' ? (
                  ...
                  >
                    <h4 className="text-xl font-serif mb-2 text-[#C5A880]">Thank You!</h4>
                    <p className="font-light">Your message has been received. We will contact you soon.</p>
                  </motion.div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      <span className="tracking-wide">{formStatus === 'sending' ? 'Sending...' : 'Send Message'}</span>
