      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            ...
            >
              Witamy w Anna salon kosmetyczny, wiodącym miejscu w Sieradz oferującym wyrafinowane doświadczenia w dziedzinie Salon Urody.
            </motion.p>
            <motion.div variants={fadeIn}>
              <a 
                href="/anna-salon-kosmetyczny-sieradz/contact" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-gray-600 max-w-2xl mx-auto font-light text-lg">
              Zanurz się w naszej starannie wyselekcjonowanej ofercie luksusowych zabiegów upiększających.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Odmłodź swoją skórę dzięki naszym autorskim, luksusowym zabiegom na twarz."
              },
              {
                title: "Rytuały Masażu",
                image: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?q=80&w=2670&auto=format&fit=crop",
                desc: "Uwolnij napięcie i przywróć harmonię swojemu ciału i umysłowi."
              },
              {
                ...
                desc: "Precyzyjne manicure i pedicure dla nieskazitelnej elegancji."
              }
            ].map((service, idx) => (
              <motion.div
                key={idx}
          ...
          >
            <div>
              ...
              <motion.p variants={fadeIn} className="text-lg text-gray-600 font-light mb-8">
                Nie wierz nam na słowo. Przeczytaj, co nasze zachwycone klientki mówią o swoich transformacjach w Anna salon kosmetyczny.
              </motion.p>
            ...
            >
              ...
              <p className="text-xl md:text-2xl font-serif italic text-gray-800 mb-8 leading-relaxed">
                "To było najbardziej luksusowe i relaksujące doświadczenie, jakie kiedykolwiek miałam. Dbałość o każdy detal i kojąca atmosfera w Anna salon kosmetyczny sprawiły, że poczułam się jak królowa. Wyszedłam stamtąd promienna i całkowicie odświeżona."
              </p>
