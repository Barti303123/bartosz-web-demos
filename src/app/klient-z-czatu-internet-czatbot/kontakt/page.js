...
const info = [
  { icon: MapPin, label: "Nasz Adres", value: "ul. Główna 1, Internet (Czatbot), Internet (Czatbot)" },
  { icon: Phone, label: "Zadzwoń", value: "+48 500 123 456" },
  { icon: Mail, label: "Napisz", value: "hello@klient-z-czatu-internet-czatbot.pl" },
            ...
            {!submitted ? (
              ...
              <div className="bg-[#F2E8DF]/30 border border-[#F2E8DF] rounded-3xl p-8 md:p-10 flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-[#7A7A7A] leading-relaxed max-w-sm">
                  ...
                  <strong className="text-[#2C2C2C] mt-2 block">{"test_fryzjer_123@gmail.com"}</strong>
                </p>
