    ...
    <main className="bg-[#FAF9F6] text-[#4A4A4A]">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden bg-gradient-to-b from-[#F2E8DF]/50 to-[#FAF9F6]">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <motion.p initial="hidden" animate="visible" variants={fade} transition={{ duration: 0.8, delay: 0.2 }} 
            ...
            Witaj w <strong>{"Klient z czatu"}</strong>. Zaufaj profesjonalistom w {"Internet (Czatbot)"} i pozwól sobie na chwilę relaksu.
          </motion.p>
          <motion.div initial="hidden" animate="visible" variants={fade} transition={{ duration: 0.8, delay: 0.3 }}>
            <a href="/klient-z-czatu-internet-czatbot/kontakt" className="inline-flex items-center gap-2 bg-[#A67C52] hover:bg-[#8F6A45] text-white px-8 py-4 rounded-full font-medium transition-colors shadow-lg shadow-[#A67C52]/20">
      ...
      <section className="py-24 px-6 text-center">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
          ...
          <a href="/klient-z-czatu-internet-czatbot/kontakt" className="inline-flex items-center gap-2 bg-[#2C2C2C] hover:bg-black text-white px-8 py-4 rounded-full font-medium transition-colors">
            Zarezerwuj Termin
          </a>
        </motion.div>
      </section>
