            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 font-light">ul. Piotrkowska 100<br/>Łódź</p>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+48 555 200 001" className="text-gray-600 font-light hover:text-[#C1A88B] transition-colors">+48 555 200 001</a>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:kontakt@studiobelle.pl" className="text-gray-600 font-light hover:text-[#C1A88B] transition-colors">kontakt@studiobelle.pl</a>
                </div>
              </div>
            </div>
          </motion.div>
