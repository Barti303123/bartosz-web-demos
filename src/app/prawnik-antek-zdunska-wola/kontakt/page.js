...
const info = [
  { icon: MapPin, label: "Odwiedź nas", value: "ul. Główna 1, Zduńska wola, Zduńska wola" },
  { icon: Phone, label: "Zadzwoń do nas", value: "+48 500 123 456" },
  { icon: Mail, label: "Napisz do nas", value: "kontakt@prawnik-antek-zdunska-wola.com" },
];
  ...
  return (
    <main className="bg-slate-950 text-white">
      ...
      <section className="relative pt-32 pb-20 text-center px-6 overflow-hidden">
        ...
        <motion.h1 initial="hidden" animate="visible" variants={fade} transition={{ duration: 0.8, delay: 0.1 }} className="relative font-serif text-5xl md:text-6xl font-bold mb-4">Kontakt z {"prawnik antek"}</motion.h1>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-28">
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} transition={{ duration: 0.7 }} className="lg:col-span-2 space-y-8">
            ...
            <p className="text-slate-400 leading-relaxed">Niezależnie od tego, czy potrzebujesz pilnej porady prawnej, czy chcesz szczegółowo omówić swoją sprawę, nasi specjaliści ds. {"Kancelaria Prawna"} w {"Zduńska wola"} są gotowi pomóc.</p>
