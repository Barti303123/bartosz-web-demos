...
export default function Cart() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      <NavbarEcommerce companyName="SUPER SKLEP JACEK" phone="+48 500 123 456" email="farti303pg@gmail.com" slug="super-sklep-jacek-lodz" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {items.length === 0 ? (
            <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
              ...
              <Link href="/super-sklep-jacek-lodz" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-colors">
                Wróć do sklepu
              </Link>
            </div>
          ) : (
