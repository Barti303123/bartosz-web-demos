        ...
        <div className="max-w-7xl mx-auto">
          ...
          {items.length === 0 ? (
            <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
              ...
              <Link href="/flora-sklep-kwiatowy-lodz" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-colors">
                Wróć do sklepu
              </Link>
            </div>
          ) : (
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="w-full lg:w-96 flex-shrink-0">
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                  ...
                  <a href="tel:+48 555 200 007" className="w-full flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white py-4 rounded-xl font-bold text-lg transition-colors">
