      ...
      <section className="pb-32 px-4 md:px-12 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col justify-center px-4 lg:px-10">
            <motion.h3 initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="text-3xl font-light uppercase tracking-tight text-white mb-6">Działamy lokalnie: Sieradz i okolice</motion.h3>
