        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/3 space-y-6">
              {[
                { icon: <MapPin className="w-6 h-6" />, title: "Nasza Lokalizacja", content: "ul. Rynek 8\nSieradz" },
                { icon: <Phone className="w-6 h-6" />, title: "Kontakt Telefoniczny", content: "+48 555 200 003" },
                { icon: <Mail className="w-6 h-6" />, title: "Adres E-mail", content: "rejestracja@meddent.pl" },
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input 
                    type="email" 
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all"
                    placeholder="rejestracja@meddent.pl"
                  />
                </div>
      ...
      <section className="h-96 bg-slate-200 relative">
        <div className="absolute inset-0 bg-slate-300 flex items-center justify-center">
          <div className="text-center text-slate-500">
            ...
            <p className="font-medium">Nasza Lokalizacja na Mapie: Sieradz</p>
          </div>
        </div>
      </section>
