      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <a href="/med-dent-klinika-sieradz/kontakt" className="inline-flex items-center gap-2 px-8 py-4 bg-cyan-600 hover:bg-cyan-700 text-white rounded-full font-medium transition-all shadow-lg hover:shadow-cyan-500/30">
              {content.hero.cta}
