    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            Tradycja zbudowana na niezachwianym oddaniu prawdzie, sprawiedliwości i nieustępliwej walce o najlepszy interes naszych klientów od samego początku naszej działalności w Łódź.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 relative">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl md:text-5xl font-serif text-white">Definiujemy Standardy Prawne w <span className="text-yellow-500">Łódź</span></h2>
            <p className="text-slate-400 leading-relaxed text-lg">
              W Kancelaria Jan Kowalski wierzymy, że każdy klient zasługuje na elitarną reprezentację prawną. Założona na zasadach uczciwości i nieustępliwości, nasza kancelaria wyrosła na potęgę uznaną za drobiazgowe przygotowanie i agresywną obronę na sali sądowej.
            </p>
            <p className="text-slate-400 leading-relaxed text-lg">
