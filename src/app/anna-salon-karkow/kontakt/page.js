            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 font-light">ul. Główna 1, Karków<br/>Karków</p>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:bartosz.waw@vp.pl" className="text-gray-600 font-light hover:text-[#C1A88B] transition-colors">bartosz.waw@vp.pl</a>
                </div>
              </div>
            </div>
          </motion.div>
