...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F6] text-[#3A332C] font-sans selection:bg-[#E3D4C4] selection:text-[#3A332C] overflow-hidden">
      <Navbar slug="anna-salon-karkow" companyName="anna salon" dark={false} />
        ...
        <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 lg:px-20 py-20 z-10 bg-[#FBF9F6]">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-xl">
            ...
            <motion.p variants={fadeInUp} className="text-lg text-gray-500 font-light mb-12 leading-relaxed max-w-md">
              Witamy w anna salon. W sercu Karków stworzyliśmy sanktuarium spokoju, w którym rzemiosło spotyka się z luksusem.
            </motion.p>
            
            <motion.div variants={fadeInUp}>
              <a href="/anna-salon-karkow/kontakt" className="group inline-flex items-center gap-6 text-sm uppercase tracking-widest font-medium">
      ...
      <section className="py-32 px-4 lg:px-12 bg-[#F6F3ED] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <a href="/anna-salon-karkow/o-nas" className="text-sm uppercase tracking-widest border-b border-[#C1A88B] text-[#C1A88B] pb-1 hover:text-[#3A332C] hover:border-[#3A332C] transition-colors mt-8 md:mt-0">Odkryj Nasze Podejście</a>
          </motion.div>
      ...
      <section className="py-32 px-4 relative overflow-hidden bg-white flex justify-center items-center">
        ...
        >
          ...
          <a href="/anna-salon-karkow/kontakt" className="inline-flex items-center justify-center px-12 py-5 bg-[#3A332C] text-white rounded-full uppercase tracking-widest text-sm hover:bg-[#C1A88B] transition-colors duration-500 shadow-xl shadow-black/10">
            Umów Konsultację
          </a>
        </motion.div>
      </section>

      <Footer companyName="anna salon" />
    </div>
  );
}