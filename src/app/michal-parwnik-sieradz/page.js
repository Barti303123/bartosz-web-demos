    ...
    <div className="min-h-screen bg-[#060D1A] text-[#F3F4F6] font-sans selection:bg-[#C5A059] selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          ...
          >
            <motion.div variants={fadeIn} className="flex items-center gap-4 mb-8">
              ...
              <span className="text-xs tracking-[0.3em] text-[#C5A059] uppercase font-semibold">Kancelaria Prawna · sieradz</span>
              <span className="w-16 h-[1px] bg-[#C5A059]"></span>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
              <a
                href="/michal-parwnik-sieradz/kontakt"
      ...
      <section className="py-24 relative overflow-hidden bg-[#0A1128]">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center flex flex-col items-center">
          ...
          <a href="/michal-parwnik-sieradz/kontakt" className="group relative px-12 py-6 bg-white text-[#060D1A] text-sm uppercase tracking-widest font-bold overflow-hidden shadow-2xl">
