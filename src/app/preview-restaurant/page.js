    ...
    <div className="min-h-screen bg-stone-950 text-stone-200 font-sans selection:bg-amber-600 selection:text-white">
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
          ...
          >
            <h2 className="text-amber-500 uppercase tracking-[0.3em] text-sm md:text-base font-semibold mb-6 drop-shadow-md">Odkryj Testowa Branża</h2>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-white mb-8 leading-tight drop-shadow-2xl">
              Symfonia <br/>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-400 via-amber-200 to-amber-500 italic drop-shadow-lg">Smaków</span>
            </h1>
            <p className="text-lg md:text-xl text-stone-200 max-w-2xl mx-auto mb-10 font-light drop-shadow-md">
              Zanurz się w niezapomnianą podróż kulinarną w Podgląd Szablonu, gdzie każde danie opowiada historię pasji, precyzji i najszlachetniejszych składników.
            </p>
