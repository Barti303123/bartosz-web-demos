    ...
    <div className="min-h-screen bg-stone-950 text-stone-200 font-sans selection:bg-amber-600 selection:text-white">
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
          ...
          >
            <h2 className="text-amber-500 uppercase tracking-[0.3em] text-sm md:text-base font-semibold mb-6 drop-shadow-md">Testowa Branża · Warszawa</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <motion.a
                href="/preview-restaurant/kontakt"
