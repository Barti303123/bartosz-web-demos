          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-stone-300 font-light text-lg leading-relaxed">
                <p>
                  Założona w sercu Warszawa, restauracja Podgląd Szablonu narodziła się z głębokiego szacunku dla sezonowych składników i ponadczasowych technik kulinarnych. Wierzymy, że posiłek to coś więcej niż tylko pożywienie – to doświadczenie, wspomnienie, chwila dzielona z bliskimi.
                </p>
                <p>
