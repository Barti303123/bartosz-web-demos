        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl font-light">
              Nie ma już na co czekać. Skontaktuj się z nami, zadzwoń lub przekrocz próg naszej ekskluzywnej przestrzeni w <span className="text-white font-bold">Bartosz siłownia</span>.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              {[
                { icon: MapPin, label: "Lokalizacja", value: "ul. Główna 1, kraków, kraków" },
