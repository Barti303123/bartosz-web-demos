        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} className="lg:w-1/2">
            ...
            <p className="text-gray-400 font-light leading-relaxed text-lg mb-10">
              W Podgląd Szablonu każdy detal ma znaczenie. Nasz zespół składa się wyłącznie z prawników posiadających rozległe doświadczenie w obsłudze najtrudniejszych transakcji na rynku.
            </p>
