      ...
      <section className="py-32 bg-[#0A1128] border-t border-white/10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}>
            ...
            <a href="/preview-law/kontakt" className="group relative inline-flex px-12 py-6 bg-white text-[#060D1A] text-sm uppercase tracking-widest font-bold overflow-hidden shadow-2xl">
