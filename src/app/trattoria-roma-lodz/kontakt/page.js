              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">ul. Piotrkowska 55<br/>Łódź</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">+48 555 200 004</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">rezerwacje@trattoriaroma.pl</p>
                  </div>
                </div>
