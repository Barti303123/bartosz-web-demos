          ...
          <div className="max-w-3xl">
            ...
            >
              <motion.div variants={fadeIn} className="flex items-center gap-2 mb-6 text-cyan-600 font-semibold tracking-wide uppercase text-sm">
                ...
                <span>Testowa Branża · Warszawa</span>
              </motion.div>
              ...
              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4">
                <a href="/preview-medical/kontakt" className="px-8 py-4 bg-cyan-600 hover:bg-cyan-700 text-white rounded-full font-medium transition-all shadow-lg hover:shadow-cyan-500/30 flex items-center justify-center gap-2">
                  <Calendar className="w-5 h-5" />
                  {content.hero.cta}
                </a>
                <a href="tel:+48 123 456 789" className="px-8 py-4 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-full font-medium transition-all flex items-center justify-center gap-2">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <p className="text-slate-600 font-medium">Twoje zdrowie i bezpieczeństwo w Warszawa to nasz priorytet.</p>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <a href="/preview-medical/o-nas" className="flex items-center gap-2 text-cyan-600 font-bold hover:text-cyan-700 transition-colors group">
      ...
      <section className="py-24 relative overflow-hidden bg-blue-900">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <a href="/preview-medical/kontakt" className="inline-block px-8 py-4 bg-white text-blue-900 rounded-full font-bold text-lg hover:bg-cyan-50 transition-colors shadow-xl">
              {content.hero.cta}
            </a>
          </motion.div>
        </div>
