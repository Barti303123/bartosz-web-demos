              ...
              <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/60 p-8 rounded-3xl relative overflow-hidden group">
                ...
                <div className="flex items-start gap-5 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 leading-relaxed font-light">ul. Deweloperska 1, Warszawa<br/>Warszawa</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/60 p-8 rounded-3xl relative overflow-hidden group">
                ...
                <div className="flex items-start gap-5 relative z-10">
                  ...
                  <div>
                    ...
                    <a href="tel:+48 123 456 789" className="text-slate-400 leading-relaxed font-light hover:text-fuchsia-400 transition-colors">+48 123 456 789</a>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/60 p-8 rounded-3xl relative overflow-hidden group">
                ...
                <div className="flex items-start gap-5 relative z-10">
                  ...
                  <div>
                    ...
                    <a href="mailto:test@podglad.pl" className="text-slate-400 leading-relaxed font-light hover:text-cyan-400 transition-colors">test@podglad.pl</a>
                  </div>
                </div>
              </div>
            </motion.div>
