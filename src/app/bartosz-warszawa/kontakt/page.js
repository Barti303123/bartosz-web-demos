            ...
            >
              <div>
                ...
                <p className="text-stone-400 font-light text-lg mb-8">
                  Z ogromną przyjemnością powitamy Państwa w bartosz. W sprawie organizacji wydarzeń prywatnych lub realizacji wyjątkowych życzeń, uprzejmie prosimy o bezpośredni kontakt.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">ul. Główna 1, Warszawa<br/>Warszawa</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 font-light">bartosz.waw@vp.pl</p>
                  </div>
                </div>
