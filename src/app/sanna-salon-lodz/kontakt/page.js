        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeIn}>
            <div className="w-full h-80 rounded-3xl overflow-hidden mb-12 shadow-xl shadow-black/5">
              <img src="https://images.unsplash.com/photo-1600948836101-f9ffda59d250?q=80&w=2668&auto=format&fit=crop" alt="Wnętrze salonu" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 font-light">ul. Główna 1, Łódź<br/>Łódź</p>
                </div>
              </div>
              <div>
