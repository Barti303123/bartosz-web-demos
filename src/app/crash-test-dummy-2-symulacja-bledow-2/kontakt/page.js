...
const info = [
  ...
  { icon: MapPin, label: "Adres", value: "ul. Główna 1, Symulacja Błędów 2, Symulacja Błędów 2" },
  { icon: Mail, label: "Email", value: "biuro@crash-test-dummy-2-symulacja-bledow-2.pl" },
      ...
      <section className="bg-gradient-to-br from-slate-50 via-blue-50/40 to-white pt-32 pb-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <motion.h1 initial="hidden" animate="visible" variants={fade} transition={{ duration: 0.6, delay: 0.1 }}
            ...
            Skontaktuj się z <span className="text-blue-600">{"🤖 Crash Test Dummy 2"}</span>
          </motion.h1>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-5 gap-16">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}
            ...
            <p className="text-gray-400 text-sm leading-relaxed">Skontaktuj się z {"🤖 Crash Test Dummy 2"} — twoim zaufanym partnerem w branży {"Test CRON"} w {"Symulacja Błędów 2"}.</p>
            ...
            {!submitted ? (
              ...
              <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-8 md:p-10 flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed max-w-md">
                  ...
                  <strong className="text-gray-900 text-base mt-2 block">{"calkowicie_popsuty_adres_bez_malpy"}</strong>
                </p>
