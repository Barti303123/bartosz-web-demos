        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="w-full lg:w-1/2">
            ...
            <motion.p variants={fadeIn} className="text-lg text-gray-500 font-light leading-relaxed mb-8">
              Od lat tworzymy przestrzeń w Warszawa, w której możesz odciąć się od zgiełku codzienności. 
              Podgląd Szablonu powstało z marzenia o miejscu, w którym innowacje technologiczne spotykają się z holistycznym, ciepłym podejściem do człowieka.
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-16 relative">
            ...
            {[
              ...
              { icon: HeartHandshake, title: "Intymna Atmosfera", text: "W Podgląd Szablonu traktujemy Cię jak gościa specjalnego, a nie pacjenta. Oferujemy dyskrecję, pyszne espresso i czas tylko dla Ciebie." }
            ].map((item, idx) => (
