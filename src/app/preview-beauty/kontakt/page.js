            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600 font-light">ul. Deweloperska 1, Warszawa<br/>Warszawa</p>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+48 123 456 789" className="text-gray-600 font-light hover:text-[#C1A88B] transition-colors">+48 123 456 789</a>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:test@podglad.pl" className="text-gray-600 font-light hover:text-[#C1A88B] transition-colors">test@podglad.pl</a>
                </div>
              </div>
            </div>
          </motion.div>
