        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
              W Kancelaria Mariusz zapewniamy niezrównaną reprezentację w skomplikowanych sprawach prawnych. Nasz oddany zespół prawników walczy nieustępliwie, aby chronić Twoje prawa i zabezpieczyć Twoją przyszłość.
            </p>
