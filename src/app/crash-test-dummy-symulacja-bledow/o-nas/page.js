...
const values = [
  { icon: Target, title: "Nasza misja", desc: "Zapewnianie wyjątkowych usług, które wspierają firmy i społeczności w Symulacja Błędów." },
        ...
        <div className="max-w-6xl mx-auto px-6 py-28 grid md:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" animate="visible" variants={fade} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight tracking-tight mb-6">
              Historia <span className="text-blue-600">{"🤖 Crash Test Dummy"}</span>
            </h1>
            <p className="text-gray-500 text-lg leading-relaxed mb-4">
              Jako zaufany dostawca z branży {"Test CRON"} w {"Symulacja Błędów"}, zbudowaliśmy naszą reputację na jakości, niezawodności i prawdziwej pasji do tego, co robimy.
            </p>
            <p className="text-gray-400 leading-relaxed">
              Znajdujemy się przy {"ul. Główna 1, Symulacja Błędów"}, {"Symulacja Błędów"} — zawsze jesteśmy tu dla naszej społeczności. Skontaktuj się z nami pod numerem {"+48 500 123 456"}.
            </p>
          </motion.div>
