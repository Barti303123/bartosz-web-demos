    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${
      ...
      <div className={`fixed inset-0 bg-white z-40 transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col gap-6 text-xl font-medium">
          <Link href="/#produkty" onClick={() => setIsMobileMenuOpen(false)} className="text-gray-900 border-b border-gray-100 pb-4">Katalog</Link>
          <Link href="/#o-nas" onClick={() => setIsMobileMenuOpen(false)} className="text-gray-900 border-b border-gray-100 pb-4">O nas</Link>
        </div>
